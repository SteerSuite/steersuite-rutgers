...
class ReactiveAI(BaseAI):
    """A simple example class"""
    _id_name = "reactive_ai_id"
    _algorithm_reff = "reactiveAI"
    _table_name = "reactive_ai_data"
    _insert_order = """(reactive_ai_id, longplan, midplan, shortplan, perceptive, predictive, reactive,
...
# (first, last, age, address, city, state)
    ...
    """reactive_ai_data 
(
    reactive_ai_id integer NOT NULL references algorithm_data(algorithm_data_id) ON DELETE CASCADE,
    longplan integer,
    midplan integer,
    shortplan integer,
    perceptive integer,
    predictive integer,
    reactive integer,
    long_term_planning_number_of_times_executed bigint NOT NULL,
    long_term_planning_total_ticks_accumulated bigint NOT NULL,
    long_term_planning_shortest_execution bigint NOT NULL,
    long_term_planning_longest_execution bigint NOT NULL,
    long_term_planning_fastest_execution double precision NOT NULL,
    long_term_planning_slowest_execution double precision NOT NULL,
    long_term_planning_average_time_per_call double precision NOT NULL,
    long_term_planning_total_time_of_all_calls double precision NOT NULL,
    long_term_planning_tick_frequency double precision NOT NULL,
    
    mid_term_planning_number_of_times_executed bigint NOT NULL,
    mid_term_planning_total_ticks_accumulated bigint NOT NULL,
    mid_term_planning_shortest_execution bigint NOT NULL,
    mid_term_planning_longest_execution bigint NOT NULL,
    mid_term_planning_fastest_execution double precision NOT NULL,
    mid_term_planning_slowest_execution double precision NOT NULL,
    mid_term_planning_average_time_per_call double precision NOT NULL,
    mid_term_planning_total_time_of_all_calls double precision NOT NULL,
    mid_term_planning_tick_frequency double precision NOT NULL,
    
    short_term_planning_number_of_times_executed bigint NOT NULL,
    short_term_planning_total_ticks_accumulated bigint NOT NULL,
    short_term_planning_shortest_execution bigint NOT NULL,
    short_term_planning_longest_execution bigint NOT NULL,
    short_term_planning_fastest_execution double precision NOT NULL,
    short_term_planning_slowest_execution double precision NOT NULL,
    short_term_planning_average_time_per_call double precision NOT NULL,
    short_term_planning_total_time_of_all_calls double precision NOT NULL,
    short_term_planning_tick_frequency double precision NOT NULL,
    
    perceptive_number_of_times_executed bigint NOT NULL,
    perceptive_total_ticks_accumulated bigint NOT NULL,
    perceptive_shortest_execution bigint NOT NULL,
    perceptive_longest_execution bigint NOT NULL,
    perceptive_fastest_execution double precision NOT NULL,
    perceptive_slowest_execution double precision NOT NULL,
    perceptive_average_time_per_call double precision NOT NULL,
    perceptive_total_time_of_all_calls double precision NOT NULL,
    perceptive_tick_frequency double precision NOT NULL,
    
    predictive_number_of_times_executed bigint NOT NULL,
    predictive_total_ticks_accumulated bigint NOT NULL,
    predictive_shortest_execution bigint NOT NULL,
    predictive_longest_execution bigint NOT NULL,
    predictive_fastest_execution double precision NOT NULL,
    predictive_slowest_execution double precision NOT NULL,
    predictive_average_time_per_call double precision NOT NULL,
    predictive_total_time_of_all_calls double precision NOT NULL,
    predictive_tick_frequency double precision NOT NULL,
    
    reactive_number_of_times_executed bigint NOT NULL,
    reactive_total_ticks_accumulated bigint NOT NULL,
    reactive_shortest_execution bigint NOT NULL,
    reactive_longest_execution bigint NOT NULL,
    reactive_fastest_execution double precision NOT NULL,
    reactive_slowest_execution double precision NOT NULL,
    reactive_average_time_per_call double precision NOT NULL,
    reactive_total_time_of_all_calls double precision NOT NULL,
    reactive_tick_frequency double precision NOT NULL,
    
    steering_number_of_times_executed bigint NOT NULL,
    steering_total_ticks_accumulated bigint NOT NULL,
    steering_shortest_execution bigint NOT NULL,
    steering_longest_execution bigint NOT NULL,
    steering_fastest_execution double precision NOT NULL,
    steering_slowest_execution double precision NOT NULL,
    steering_average_time_per_call double precision NOT NULL,
    steering_total_time_of_all_calls double precision NOT NULL,
    steering_tick_frequency double precision NOT NULL,
    
    number_of_times_executed bigint NOT NULL,
    total_ticks_accumulated bigint NOT NULL,
    shortest_execution bigint NOT NULL,
    longest_execution bigint NOT NULL,
    fastest_execution double precision NOT NULL,
    slowest_execution double precision NOT NULL,
    average_time_per_call double precision NOT NULL,
    total_time_of_all_calls double precision NOT NULL,
    tick_frequency double precision NOT NULL,
    
    percent_mid_term double precision NOT NULL,
    percent_short_term double precision NOT NULL,
    percent_perceptive double precision NOT NULL,
    percent_predictive double precision NOT NULL,
    percent_reactive double precision NOT NULL,
    percent_steering double precision NOT NULL,
    average_per_agent double precision NOT NULL,
    average_per_agent_4hz double precision NOT NULL,
    average_per_agent_5hz double precision NOT NULL,
    
        --  TODO: 20 frames per second is a hard-coded assumption in the following calculations
    average_frequency_mid_term double precision NOT NULL,  -- :   0.0542373 Hz (skipping 368.75 frames)
    average_frequency_short_term double precision NOT NULL,  -- : 20 Hz (skipping 1 frames)
    average_frequency_perceptive double precision NOT NULL,  -- : 20 Hz (skipping 1 frames)
    average_frequency_predictive double precision NOT NULL,  -- : 0 Hz (skipping inf frames)
    average_frequency_reactive double precision NOT NULL,  -- :   20 Hz (skipping 1 frames)
    average_frequency_steering double precision NOT NULL,  -- :   20 Hz (skipping 1 frames)
    
    amortized_percent_mid_term double precision NOT NULL,
    amortized_percent_short_term double precision NOT NULL,
    amortized_percent_perceptive double precision NOT NULL,
    amortized_percent_predictive double precision NOT NULL,
    amortized_percent_reactive double precision NOT NULL,
    amortized_percent_steering double precision NOT NULL,
    average_per_agent_per_update double precision NOT NULL,
    CONSTRAINT reactiveAI_pkey PRIMARY KEY (reactive_ai_id)
) """
    ...
    def __init__(self, longplan=0, midplan=0, shortplan=0, perceptive=0, predictive=0, reactive=0,
        ...
        super(ReactiveAI,self).__init__(number_of_times_executed,
                total_ticks_accumulated,
                shortest_execution,
                longest_execution,
                fastest_execution,
...
# Must be a very well formed dict for the values to be assigned correctly.
    def setValuesFromDict(self, valuesList):
        ...
        super(ReactiveAI,self).setValuesFromDict(valuesList) 
