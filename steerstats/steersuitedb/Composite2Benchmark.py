...
class Composite2Benchmark(Composite1Benchmark):
    """A simple example class"""
    _id_name = "benchmark_id"
    _table_name = "composite02_benchmark_technique"
    _insert_order = """(
    benchmark_id,
    scenario_id  ,
    frames ,
...
#)
    ...
    def __init__(self, algorithm_data_id=0, test_comments="", benchmark_id=0, test_case="", test_status=0, scenario_group=0,    
        ...
        super(Composite2Benchmark,self).__init__(algorithm_data_id, test_comments, benchmark_id, test_case, test_status, scenario_group,    
                scenario_id,
                frames,
                rand_calls,
                collisions,    
    ...
    def setBenchmarkValuesFromDict(self, valuesDict):
        super(Composite2Benchmark,self).setBenchmarkValuesFromDict(valuesDict)
        
        self._acceleration=valuesDict['acceleration']
    ...
    def insertBenchmark(self, cur, 
        ...
        try:
            ...
            cur.execute("INSERT INTO " + self._table_name + " " +
                        ...
                        ",%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", # 24
                        ( 
            ...
            print 'Error insertComposite2Benchmark: %s' % e    
    ...
    def del_acceleration(self):
        del self.__acceleration

    acceleration = property(get_acceleration, set_acceleration, del_acceleration, "acceleration's docstring")
