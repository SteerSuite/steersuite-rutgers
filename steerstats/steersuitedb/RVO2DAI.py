...
class RVO2DAI(BaseAI):
    _id_name = "rvo2d_ai_id"
    _algorithm_reff = "rvo2dAI"
    _table_name = "rvo2d_ai_data"
    _insert_order = """(rvo2d_ai_id,
...
#rvo2d_ai_data 
#(
#  rvo2d_ai_id integer NOT NULL references algorithm_data(algorithm_data_id) ON DELETE CASCADE,
...
#  CONSTRAINT rvo2d_ai_pkey PRIMARY KEY (rvo2d_ai_id)
#) ;
    ...
    def __init__(self,  number_of_times_executed=0,
                ...
                tick_frequency=0):
        super(RVO2DAI,self).__init__(number_of_times_executed,
                total_ticks_accumulated,
                shortest_execution,
                longest_execution,
                fastest_execution,
    ...
    def setValuesFromDict(self, valuesDict):
        super(RVO2DAI, self).setValuesFromDict(valuesDict)
