...
/// @file CurveAIModule.cpp
/// @brief Implements the CurveAIModule plugin.
...
using namespace CurveAIGlobals;

PLUGIN_API SteerLib::ModuleInterface * createModule()
{
	return new CurveAIModule;
}
...
void CurveAIModule::init( const SteerLib::OptionDictionary & options, SteerLib::EngineInterface * engineInfo )
{
	gEngine = engineInfo;
...
void CurveAIModule::initializeSimulation()
{
	//
...
void CurveAIModule::preprocessSimulation()
{
	//TODO does nothing for now
}

void CurveAIModule::preprocessFrame(float timeStamp, float dt, unsigned int frameNumber)
{
	//TODO does nothing for now
}

void CurveAIModule::postprocessFrame(float timeStamp, float dt, unsigned int frameNumber)
{
	//TODO does nothing for now
}

void CurveAIModule::cleanupSimulation()
{
...
void CurveAIModule::finish()
{
	// nothing to do here
}

SteerLib::AgentInterface * CurveAIModule::createAgent()
{
	return new CurveAgent; 
}

void CurveAIModule::destroyAgent( SteerLib::AgentInterface * agent )
{
	delete agent;
}
