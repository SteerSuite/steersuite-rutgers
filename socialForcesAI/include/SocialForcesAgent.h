...
protected:
	...
	*/
	...
	std::set<std::string> SeekTarget;
	std::set<std::string> FleeTarget;
	void pursueAndEvade_acceleration(float dt, Util::Vector &_acceleration);
	//Util::Vector SocialForcesAgent::Wallfollower(float dt, Util::Vector &_acceleration);
